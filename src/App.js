...
/*Customer statement card end */
    return(
      <div className="main-div">
          ...
          <Heros2 link={heros2_image} title={heros2_title} content={heros2_content}/> 
        <div className="md:flex justify-center ">
         ...
         <Heros2 link="/Images/Engagement1.png" title="Our Engagement Models" content={engagement_content} />
         <FooterContact/>
         <Footer/>
        </div>
      );
